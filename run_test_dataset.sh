...
python  $RECOVAR_PATH/recovar/estimate_conformational_density.py test_dataset/pipeline_output --deconvolved_dim 2

python $RECOVAR_PATH/compute_trajectory.py pipeline_output -o test_dataset/pipeline_output/trajectory1 --endpts test_dataset/pipeline_output/analysis_2_noreg/kmeans_center_coords.txt --density test_dataset/pipeline_output/density/deconv_density_knee.pkl

# option 2
python $RECOVAR_PATH/compute_trajectory.py pipeline_output -o test_dataset/pipeline_output/trajectory1 --endpts test_dataset/pipeline_output/analysis_2_noreg/kmeans_result.pkl --density test_dataset/pipeline_output/density/deconv_density_knee.pkl --kmeans-ind=0,1
