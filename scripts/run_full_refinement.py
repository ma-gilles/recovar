...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Particle diameter in Angstroms, matching RELION --particle_diameter. "
        "Used for the Crowther angular-step bound. Without it the convergence "
        "criterion cannot detect 'fine enough' sampling and refinement runs "
        "to max_healpix_order.",
    )
    parser.add_argument(
        "--max_healpix_order",
        type=int,
