...
for helper in (
    ...
    "helpers.sparse_bucket_arrays", "helpers.compact_candidates", "helpers.pass2_diagnostics", "helpers.norm_scale_diagnostics", "helpers.relion_ctf", "helpers.scale_groups", "helpers.normalization_inputs",
