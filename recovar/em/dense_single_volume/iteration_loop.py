...
``_run_relion_iteration_loop`` manages refinement state and dispatch. Local
search is implemented in ``local_search_iteration``; state-swap diagnostics
are owned by ``helpers.state_swap_runtime``.
