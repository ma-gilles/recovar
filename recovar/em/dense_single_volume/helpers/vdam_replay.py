...
this module does not import the local engine or run a replay. Candidate block-map schema and publication also live here; the engine retains
the call at the captured numerical boundary.
"""
