...
fused batch runner. The refinement controller and K-class adapters select this
engine alongside the exact-local and sparse routes.

See ``docs/math/relion_refinement_algorithm.md`` for scoring conventions,
execution paths and the distinction between blockwise and adaptive passes.
"""
...
from recovar.em.helpers.image_shifts import (
    apply_relion_integer_pre_shifts,
    integer_pre_shifts_or_none,
    tiled_half_image_phase_factors,
)
from recovar.em.helpers.preprocessing import image_preprocess_backend, process_half_image
from recovar.em.helpers.preprocessing import prepare_reconstruction_batch as _prepare_reconstruction_batch
...
from recovar.em.helpers.timing import TimingAccumulator
...
from recovar.em.helpers.types import DenseEMResult, EMProfileStats, make_noise_stats, make_relion_stats
from recovar.em.scoring.score_constraints import DenseScoreConstraints, apply_dense_score_constraints
