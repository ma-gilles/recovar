...
def relion_x_public_output_to_bpref(
    ...
    selecting the positive-x slab.  This is intentionally separate from
    :func:`run_em_output_to_bpref`, whose input is already a centered RECOVAR
    Fourier cube and therefore must not be transposed.
    """
