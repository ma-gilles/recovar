...
reconstruction-weight and resolution-shell rules live here. Optional native
replay readers live in ``diagnostics.vdam_mstep_replay``;
...
from recovar.em.diagnostics import vdam_mstep_replay as replay
