import { e as setGet, g as get, p as proxy, h as chain } from '../../macros2.js';
...
function vtkAbstractRepresentationProxy(publicAPI, model) {
  ...
  publicAPI.getColorBy = () => {
    ...
    if (colorMode === vtkMapper.ColorMode.MAP_SCALARS && colorByArrayName) {
      ...
      const componentIndex = lut.getVectorMode() === vtkScalarsToColors.VectorMode.MAGNITUDE ? -1 : lut.getVectorComponent();
