...
const TRIANGLE_CASES = [[-1, -1, -1, -1, -1, -1, -1], [0, 2, 100, -1, -1, -1, -1], [1, 0, 101, -1, -1, -1, -1], [1, 2, 100, 1, 100, 101, -1], [2, 1, 102, -1, -1, -1, -1], [0, 1, 102, 102, 100, 0, -1], [0, 101, 2, 2, 101, 102, -1], [100, 101, 102, -1, -1, -1, -1]];
    ...
    for (let edgeIdx = 0; triangleCase[edgeIdx] > -1; edgeIdx += 3) {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        if (edgeValue >= 100) {
          ...
          pts[i] = id;
          if (inserted) {
            outPd.interpolateData(inPd, model.pointsIds[e1], model.pointsIds[e2], id, t);
          }
        }
      }
