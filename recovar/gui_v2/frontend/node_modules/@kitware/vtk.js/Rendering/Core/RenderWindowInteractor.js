...
function vtkRenderWindowInteractor(publicAPI, model) {
  ...
  function handleChordedButtons(callData, previous, current) {
    ...
    if ((previous & ~current & 1) !== 0) publicAPI.leftButtonReleaseEvent(callData);
    if ((previous & ~current & 4) !== 0) publicAPI.middleButtonReleaseEvent(callData);
    if ((previous & ~current & 2) !== 0) publicAPI.rightButtonReleaseEvent(callData);
    if ((~previous & current & 1) !== 0) publicAPI.leftButtonPressEvent(callData);
    if ((~previous & current & 4) !== 0) publicAPI.middleButtonPressEvent(callData);
    if ((~previous & current & 2) !== 0) publicAPI.rightButtonPressEvent(callData);
        ...
        default:
          {
            ...
            /* eslint-disable no-bitwise */
            handleChordedButtons(callData, previousMouseButtons & ~buttonBit, event.buttons & ~buttonBit);
            /* eslint-enable no-bitwise */
