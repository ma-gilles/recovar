...
for log_n in [5]:
    ...
    output_folder = volume_folder_input+ f"/dataset_{log_n}_radial_nocont/"
    ...
    image_stack, sim_info = simulator.generate_synthetic_dataset(output_folder, voxel_size, volume_folder_input, n_images,
                                   ...
                                   volume_radius = 0.6, trailing_zero_format_in_vol_name = True, noise_scale_std = 0.2 * 0, contrast_std =0.0  , disc_type = 'nufft')
