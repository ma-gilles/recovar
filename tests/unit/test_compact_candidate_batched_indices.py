...
from recovar.em.scoring import compact_candidates as cc
...
def _host_reference_at_capacity(masks, pair_bucket_size, n_alloc):
    from recovar.em.scoring.sparse_bucket_arrays import _rows_at_capacity
...
def test_auto_pair_bucket_quantum_follows_mean_valid_pairs(monkeypatch, mean_valid, expected):
    ...
    from recovar.em.scoring import sparse_bucket_arrays as bucketed_mod
