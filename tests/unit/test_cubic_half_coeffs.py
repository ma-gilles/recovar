...
class TestCubicSlicingEquivalence:
    ...
    def test_half_image_matches_full_image(self):
        ...
        coeff_volume = slicing.CubicVolume.from_coeffs(coeffs)
    ...
    def test_precomputed_matches_direct(self):
        ...
        direct = slicing.slice_volume(
            slicing.CubicVolume.from_coeffs(coeffs),
            rots,
            image_shape,
            volume_shape,
            max_r=None,
    ...
    def test_half_volume_slicing_matches_full_volume(self):
        ...
        result_full = slicing.slice_volume(
            slicing.CubicVolume.from_coeffs(full_coeffs),
            rots,
            image_shape,
            volume_shape,
            max_r=None,
        ...
        result_half = slicing.slice_volume(
            slicing.CubicVolume.from_coeffs(half_coeffs, half_volume=True),
            rots,
            image_shape,
            volume_shape,
            half_image=False,
