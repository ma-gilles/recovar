...
from recovar.em.ppca_refinement.engine import dense_pose_ppca_score_with_moments_blocked
...
def test_dense_q0_matches_homogeneous_score_expression():
    ...
    scored = dense_pose_ppca_score_with_moments_blocked(Y1, proj_aug, ctf2_over_noise, y_norm)
...
def test_dense_w_zero_matches_q0_log_evidence_and_best_pose():
    q0 = _fixture(q=0)
    w0 = _fixture(q=2)
    scored_q0 = dense_pose_ppca_score_with_moments_blocked(*q0)
