...
from recovar.em.sparse_pass2 import sparse_pass2_bucketed, sparse_pass2_compact_pair_sums, sparse_pass2_noise_blocks


def test_owner_holds_the_sums_and_the_pass2_module_routes_to_them():
    pass2_src = inspect.getsource(sparse_pass2_bucketed)
    for name in ("_compact_pair_weighted_rotation_and_image_sums", "_compact_pair_weighted_sums_and_noise_native", "_compact_pair_dense_probs", "_compute_active_noise_rows_chunked", "_rectangular_active_weighted_sums"):
