...
def test_fine_score_capture_accepts_k1_fine_score_panel_schema(tmp_path):
    selection = tmp_path / "selection.json"
...
def test_fine_score_capture_accepts_same_process_final_boundary_schema(tmp_path):
    selection = tmp_path / "selection.json"
    _k1_selection(
        selection,
        ranks=(1, 2),
