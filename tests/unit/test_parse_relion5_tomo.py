...
class TestTomogram:
    ...
    def test_expand_particles_batch_row_count(self):
        n = 4
        tomo = Tomogram(
            pixel_size=1.0,
    ...
    def test_expand_particles_batch_without_orientation(self):
...
class TestConvert:
    ...
    def test_partial_visible_frames(self, tmp_path):
        ...
        output = str(tmp_path / "output.star")
        convert(str(tomo_star), str(p_star), output)
...
class TestGeometryConsistency:
    ...
    def test_orientation_composition_order(self):
        ...
        # The expand_particles_batch method should use R_base @ tilt_rotation
        tomo = Tomogram(
            pixel_size=1.0,
    ...
    def test_matches_reference_defocus(self):
...
class TestTomogramEdgeCases:
    ...
    def test_expand_particles_batch_dose_columns_are_float(self):
    ...
    def test_many_tilts_constructor(self):
        ...
        assert tomo.n_tilts == n
        # Verify defocus is finite for a sample point
        u, v, a = tomo.local_defocus(50, np.array([500.0, -300.0, 200.0]))
    ...
    def test_single_tilt(self):
        ...
        # At origin with zero tilt, defocus should match global
        u, v, a = tomo.local_defocus(0, np.array([0.0, 0.0, 0.0]))
        assert u == pytest.approx(25000.0)
        assert v == pytest.approx(26000.0)
...
class TestQuantitativeGeometry:
    ...
    def test_multiple_random_points_defocus_finite(self):
        """Stress test: many random points and parameters produce finite defocus."""
