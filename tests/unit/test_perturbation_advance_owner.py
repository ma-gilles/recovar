...
def test_explicit_seed_draws_from_seed_plus_iteration():
    rp, seed = sampling._advance_relion_perturbation(0.1, perturb_factor=0.5, perturb_seed=np.int64(100), relion_iteration=7, rng=None)
...
def test_generator_path_reports_no_seed():
    ...
    rp, seed = sampling._advance_relion_perturbation(0.1, perturb_factor=0.5, perturb_seed=None, relion_iteration=7, rng=rng_a)
