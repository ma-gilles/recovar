# EM cleanup history through 121144413 — September 9, 2026

Historical snapshot of `docs/development/em_status.md` at
`1211444135adcb3a06876e434a557d08aea6b349`. Everything below the separator is
preserved byte-for-byte, including superseded next actions and failed checks.
These records qualify only their pinned sources. See the
[current status](em_status.md) for active work and ownership.
...
[`local_projection_cache.py`](https://github.com/ma-gilles/recovar/blob/b77d0a7bf36677a2fee01f8ce3fe9a938c82d4c4/recovar/em/dense_single_volume/local_projection_cache.py).
