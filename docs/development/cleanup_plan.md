...
| K-class execution and comparisons | The PR158 undefined-variable repair is held separately. Older repaired-control K2 passes; K8/K16 retain historical failures, and K16 has a class/pose flip without score margins. The historical exact-K4 pair started September 8 in Slurm13560202; its audit remains pending. | Resolve the repair separately; qualify the selected source against the explicitly repaired control for K2/K4/K8/K16 and preserve every failed seed/class. |
