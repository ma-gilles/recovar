> Historical snapshot preserved on 2026-09-08. Source identities, failed runs
> and old next actions below describe their recorded checkpoints. For current
> scope and next work, read [the active EM status](em_status.md).
