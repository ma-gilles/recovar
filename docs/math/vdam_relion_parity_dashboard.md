...
| ➡️ | What is next? | Replace or isolate the within-particle hypothesis scatter/reduction at the low-resolution iteration-1--3 M-step, then rerun the exact particle-286 @4 gate. Keep this in the shared EM engine so supplied-map EM and InitialModel have one accumulator implementation. Only a repeat-robust @4 pass can advance to 0--20/0--200 and the frozen matrix. |
...
|---:|---|---|---|---|
| 1 | GF46 particle-286 posterior @4 | exact capture proves one candidate-only coarse parent causes the alternate fine orientation. Process-isolation variants produce one green and four red realizations, and one-particle BPref buckets remain red. Expected-accuracy math, process lifetime, helper CUDA context, and cross-particle bucket interleaving are all insufficient | direct captures `13111783 / 13111784`; isolation panel `13112549 / 13112995 / 13113892 / 13114264 / 13115118`; chunk-1 `13115513`; current science `42d511684` | implement a shared within-particle deterministic scatter/reduction discriminator, then qualify repeat-robust @4 before 0--20/0--200; no score change yet |
