...
`13132747` is queued on the pinned node. Submission `13132648` was cancelled
while pending so that it could not run the intrusive coarse observer; setup
