...
> [Focused report.](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_allten_stable_same_state_it48_h100_13394745.md)
>
...
> at repeat-scale noise. [Focused report.](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_static_geometry_batched_posterior_h100_13393862.md)
>
...
> promotion. [Focused report.](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_runtime_stack_trajectory_h100_13392701.md)
>
...
> so it is recorded but not promoted. [Focused report.](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_static_half_geometry_h100_13393276.md)
>
...
| Stable-shape exact-state transition | **HARD STATE EXACT / ATOMIC HOLD** | Job `13394745` passes all four crossed hard-state comparisons from one live iteration-47 state. Continuous accumulator/final-state changes are tiny but outside the strict repeat envelope; warm fixed-size wall is +2.73%, confirming the trajectory value is compile avoidance. Particle 2798 has a clear shared-state margin; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_allten_stable_same_state_it48_h100_13394745.md). |
| Static geometry + shared batched posterior | **23/23 EXACT / 2,410 FEWER KERNELS** | Job `13393862` improves warm replay `5.144 -> 4.386 s` (-14.75%) and Nsight span `1.689 -> 1.454 s` (-13.91%) versus `13391819`. The shared posterior primitives remove exactly 2,040 launches on top of static geometry; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_static_geometry_batched_posterior_h100_13393862.md). |
| Complete optimized `0 -> 50` stack | **45.15% FASTER / STRICT SCIENCE HOLD** | Job `13392701` changes median fresh wall `500.604 -> 274.569 s`, expectation `471.249 -> 239.133 s`, and memory +0.04%. Candidate 1 stays hard-state exact; candidate 2 changes one pose at iterations 48 and 50. Runtime passes, defaults and frozen scores do not; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_runtime_stack_trajectory_h100_13392701.md). |
| Shared static half-spectrum geometry | **23 / 23 EXACT / 41 FEWER COMPILES** | Comparable optimized H100 replay `13393276` changes stderr compile count `435 -> 394`, recorded miss time `22.596 -> 21.918 s`, cold wall `30.069 -> 29.915 s`, and warm wall `5.144 -> 4.569 s`. Strict atomic diagnostics are only 14/21 at nondeterministic scale and are not promoted; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_static_half_geometry_h100_13393276.md). |
...
| Fixed flat-row ABI isolation | **9.37% WALL GAIN / STRICT SCIENCE FAIL** | Job `13378054` disables Fourier bucketing and changes only `Q` to `B*R`. Wall changes `512.628 -> 464.613 s`, expectation `479.372 -> 433.451 s`, and big-JIT variants fall `87 -> 48/49`. Ordinary repeats retain exact hard state; candidate repeats first split at iteration 29 and candidate 2 first differs from ordinary at iteration 35. Keep default-off; [report](https://github.com/ma-gilles/recovar-experiments/blob/dca48f2d42514216059e27313008967c8afc34bb/docs/perf/vdam_stable_flat_only_trajectory_h100_13378054.md). |
...
| Shared projection cache | Source `43402732cb169ab5d91d90b10262a35ba99edae4`; job `13332001`; H100 `GPU-2ee3da91-970a-6714-84df-530aefe04a08`; result SHA-256 `576384429d01fbe2d86a81c13a7519c484490e5ac62bb8bc871387df653023c2`; [archived report; private](https://github.com/ma-gilles/recovar-experiments/blob/a04918d429b79fc771d8b8660d5af8201b15fc0b/docs/perf/vdam_projection_cache_h100_13332001.md). |
| Integrated hybrid H100 boundary | Source `b611aeff15004a07d6d2a1ec590bc5b97180cb5b`; job `13341618`; H100 `GPU-2ee3da91-970a-6714-84df-530aefe04a08`; artifact-manifest SHA-256 `fec2ec40f98057a428799a472ea36908725c24ed54041d21ceacd99cf0ef325a`; [report](https://github.com/ma-gilles/recovar-experiments/blob/9d86b5d87e402a5c92a2c44f06468fa9d5fcd5fb/docs/perf/vdam_gf46_hybrid_batch_h100_13341618.md). |
| GF46 integrated-hybrid one-transition seal | Source `85c4b13bf5f7b975ea4504750fe8495556e6030c`; job `13344325`; H100 `GPU-75c2d200-95d1-ef57-fb52-1698386c756c`; report JSON SHA-256 `10649aa2916269335f7615d399c0a3388bf722a49a0223b6f2acc7a863535351`; [archived report; private](https://github.com/ma-gilles/recovar-experiments/blob/535d077332b6a5ed26eacce83da43d528a7bff88/docs/perf/vdam_gf46_hybrid_transition_h100_13344325.md). |
...
| GF46 same-state iteration-35 boundary | Source `2fc852da7a408d32dd0142fb177371de0407c552`, job `13358712`, H100 `GPU-9f98ccbf-3c62-c54f-7409-7eb58845ad4a`, report JSON SHA-256 `a3809404cf10f5c4dd473c3a09795189cc07c543fb3b7d9d89b8fc892c3e7153`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_hybrid_same_state_it35_h100_13358712.md). |
| Shared fixed-capacity multi-call seam | Source `231a0191cc17615fe97eef9a3894b93a824f5a64`, job `13359718`, H100 `GPU-099c0d77-bb85-f2e9-f628-148b733c9176`, source manifest SHA-256 `eb668b8bb28adb7ade5aefb9ec73f8bb8bfc85bc76eb5209035838286a528c3f`, result SHA-256 `96374d0c934f870f6f20ef0edf38c3ab4dc924fcea5cf0879e3abce19c2fc840`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/fixed_capacity_local_multicall_h100_13359718.md). |
| Segmented fixed-capacity scan | Source `560c1a6c754328140613fa5a2e3aea7b3e17afe3`, job `13360809`, H100 `GPU-099c0d77-bb85-f2e9-f628-148b733c9176`, run JSON SHA-256 `4035dfc21008b751d9c9cd9b905cfcf49bf6e90c7de0dda3ae380b2edb6c207c`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/fixed_capacity_segmented_scan_h100_13360809.md). |
| Packed fine-row primitive | Source `bc800e4fa2e5a607a6a4ecd480a174e0ca5ca628`, job `13361586`, H100 `GPU-099c0d77-bb85-f2e9-f628-148b733c9176`, run JSON SHA-256 `69866a5f13f64c3c4cb13dfc12647d635883188296abf23404d1ba5f65667ece`; [archived report; private](https://github.com/ma-gilles/recovar-experiments/blob/a04918d429b79fc771d8b8660d5af8201b15fc0b/docs/perf/vdam_flat_row_score_h100_13361586.md). |
| Packed fine rows at production seam | Source `1de2e224b2aed0659cf954e4763fb1ef260355f5`, job `13362546`, H100 `GPU-0d7b80c7-fef8-e346-6332-de36ae1af518`, report JSON SHA-256 `0e255292085570ed3ee92a08450da083664bd31dd3794ecbae6dc4aaaf6536ee`; [report](https://github.com/ma-gilles/recovar-experiments/blob/dca48f2d42514216059e27313008967c8afc34bb/docs/perf/vdam_flat_rows_same_state_it35_h100_13362546.md). |
| Packed projection at production seam | Source `cb5855d8367b452d48b6765f7e9265ed8d076ca4`, job `13363465`, H100 `GPU-0d7b80c7-fef8-e346-6332-de36ae1af518`, report JSON SHA-256 `825791a60b2e35168b807020b6bc7bc32bb149b5c82fe9c7b3be45ecb7de855c`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_packed_projection_same_state_it35_h100_13363465.md). |
| Final-support VDAM deferral | Source `fea9ae567e732d013860737e2cf5f2022c548818`, job `13364363`, H100 `GPU-0d7b80c7-fef8-e346-6332-de36ae1af518`, report JSON SHA-256 `55bb5760935c5ea1314ad9591558f8ba281f71f88141201e8b58c18383459afe`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_packed_deferred_same_state_it35_h100_13364363.md). |
| Dense-order final-support diagnostic | Source `0e1b4355c85b024d45b4782bdca6f7eba2656223`, job `13366669`, H100 `GPU-235ec3bc-ca9f-1c0e-88eb-c8b37c5e0480`, report JSON SHA-256 `ec6ded886dff2465a536b2c6c987092d91d40beac68b3cade57eac712764cf78`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_packed_deferred_dense_order_it35_h100_13366669.md). |
| Exact scoring-projection reuse | Source `cf9791d35e2b97cd5b64426aab33b749e3b50ce3`, diagnostic job `13367167`, clean job `13367508`, H100s `GPU-990435ac-e5fe-18d9-c741-59b8fd9c9439` and `GPU-5297e2fc-3064-625f-a65a-9db11614d705`, report JSON SHA-256s `1a02a96533fbd1b7d9c111da056aef41f35ead8cbc032e05b578d8f6e10c7313` and `6a979206fdb062678862d378d25516093bdad3fe83d41e63af21eadc6633ad08`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_packed_deferred_projection_reuse_it35_h100_13367167_13367508.md). |
| Combined hybrid + packed-deferred transition | Source `209aae4593f0a040090e150482f9d44dfa57e79f`, job `13368042`, H100 `GPU-0d7b80c7-fef8-e346-6332-de36ae1af518`, report JSON SHA-256 `302b222ebc223d580314012e6cc423f467981d96f24d2bd6bc0aff278ae5ebe1`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_hybrid_packed_deferred_same_state_it35_h100_13368042.md). |
...
| Combined iteration-48 causal gate | Source `10cd188edc4d81d038e582c277c65d60396368d1`, job `13372936`, H100 `GPU-e2c3190a-9599-15f7-a19c-7ae55e4e0a85`, report JSON SHA-256 `e734d48748cc6ae41f3851df5878b8928456d3b32db31fd39511b0927c5cec5e`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_combined_same_state_it48_h100_13372936.md). |
| Stable Fourier-shape trajectory | Source `47190851099ba608d60114de1df0624e9efe8e1a`, job `13372996`, H100 `GPU-ddb1592d-744e-ea56-d0a3-aec6e7c97d10`, analyzer report SHA-256 `037cdda817bb5914d6836aaf305ea2a6383539035620909fef602c586b316149`; [archived report; private](https://github.com/ma-gilles/recovar-experiments/blob/a04918d429b79fc771d8b8660d5af8201b15fc0b/docs/perf/vdam_stable_shapes_trajectory_h100_13372996.md). |
| Shared local-projection-cache rejection | Source `8816d487e76540690e8e38cfa12bd014ba5d856f`, job `13373715`, H100 `GPU-0d7b80c7-fef8-e346-6332-de36ae1af518`, report SHA-256 `0ec47650576126f977380235595402e5766cf43671c856e665fa86ce7256c557`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_local_projection_cache_it48_h100_13373715.md). |
| Validity-aware packed fine rows | Source `4dc4a79f7c5f6f31d7a8e04bfe43339b700b48c6`, same-state jobs `13374637`/`13374638`, dedicated timing job `13375396`, H100 `GPU-75c2d200-95d1-ef57-fb52-1698386c756c`, timing manifest SHA-256 `d89361d388017f55ec77f9948673c6de6307594ab4f55edde697b4a88b2e5481`; [science report](https://github.com/ma-gilles/recovar-experiments/blob/dca48f2d42514216059e27313008967c8afc34bb/docs/perf/vdam_flat_row_validity_it48_h100_13374637.md), [timing report](https://github.com/ma-gilles/recovar-experiments/blob/dca48f2d42514216059e27313008967c8afc34bb/docs/perf/vdam_flat_row_invalid_early_exit_h100_13375396.md). Integrated source `9ae038377778419d5ead8f96c5eb75753807fd8d`, job `13376273`, CUDA SHA-256 `870ac72044ef78bcccd1ab695b9991b088cc42512231d1a3cafc000ea32ea777`. |
| Stable packed-row ABI | Source `2957ae6a4e4d81ca9c5524871f4e9609c2d9d39d`, job `13376686`, H100 `GPU-1fdb3b99-e7ff-fe6d-4f59-9d2cc85fa319`, report JSON SHA-256 `1eb3d9a92aa9886c7a08cdca91ae9f06899b4a2ab845f8cbfaf2d5a6bf5a8b42`; [report](https://github.com/ma-gilles/recovar-experiments/blob/dca48f2d42514216059e27313008967c8afc34bb/docs/perf/vdam_stable_flat_capacity_same_state_it48_h100_13376686.md). |
| Combined stable-ABI trajectory | Source `f5792e9b0af6a70f13cb63a546d594013c774f16`, job `13377009`, H100 `GPU-e2c3190a-9599-15f7-a19c-7ae55e4e0a85`, report JSON SHA-256 `a39f95b6b0f56b95b1f7e91bd6531f9b7c1a4d582c37e94503cf9656c13400e0`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_stable_combined_abi_trajectory_h100_13377009.md). |
| Fixed flat-row ABI-only trajectory | Run source `64d6433c41a87370a70d779415b5df95ca53a188`, diagnostic analyzer `d3e29dafe`, job `13378054`, H100 `GPU-e2c3190a-9599-15f7-a19c-7ae55e4e0a85`, report JSON SHA-256 `265166b28c0268bdec081e5ba27c1e3954e22ee0541bbab276a44d45d3541f54`; [report](https://github.com/ma-gilles/recovar-experiments/blob/dca48f2d42514216059e27313008967c8afc34bb/docs/perf/vdam_stable_flat_only_trajectory_h100_13378054.md). |
| Compact posterior + packed/deferred transition | Source `17ec60ca5dcd5d3b67e956876d9df07ed2a6345d`, job `13377600`, H100 `GPU-0d7b80c7-fef8-e346-6332-de36ae1af518`, science report SHA-256 `3e7b0b0df783adc2ce8c64ddd3e2860ea2f0c87908ca6cc5c938694f7dc62b25`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_compact_packed_same_state_it48_h100_13377600.md). |
| Fully optimized nine-seam transition | Source `0729473a1a752f1474edd666ae0740ef692049ed`, job `13378175`, H100 `GPU-ef985070-011e-0782-6f0a-94b053dcc120`, science report SHA-256 `5976788bbb57f4dbe88726e2f315050fd305e8ebf1dc39648d3ece6246057f54`; [report](https://github.com/ma-gilles/recovar-experiments/blob/f34b8e79320116a9965954156f4edfe14257929a/docs/perf/vdam_all_optimized_same_state_it48_h100_13378175.md). |
