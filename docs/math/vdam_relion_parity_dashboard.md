...
1. Keep the clean tracking-derived batched-lane port default-off. Its 9.03% warm-wall gain is material, but immutable job 13285647 remains a frozen two-repeat strict FAIL. The separately predeclared 8+8 panel `13286397` passes after independently reviewed serializer-only recovery at `f8cea5d209`. The first true-200 seal `09d11dba7979` received independent NO-GO and was not submitted. Repair it as a crossed 6+6 no-growth, variance-growth, basin, final-quality, provenance, and end-to-end runtime gate, then obtain a fresh independent review before Slurm.
