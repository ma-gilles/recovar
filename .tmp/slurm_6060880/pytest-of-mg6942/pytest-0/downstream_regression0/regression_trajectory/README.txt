...
Command: python /scratch/gpfs/GILLES/mg6942/recovar_wt_output_cleanup/recovar/command_line.py /scratch/gpfs/GILLES/mg6942/recovar_wt_output_cleanup/.tmp/slurm_6060880/pytest-of-mg6942/pytest-0/downstream_regression0/pipeline_output -o /scratch/gpfs/GILLES/mg6942/recovar_wt_output_cleanup/.tmp/slurm_6060880/pytest-of-mg6942/pytest-0/downstream_regression0/regression_trajectory --zdim 4 --endpts /scratch/gpfs/GILLES/mg6942/recovar_wt_output_cleanup/.tmp/slurm_6060880/pytest-of-mg6942/pytest-0/downstream_regression0/analysis_output/kmeans/centers.txt --ind 0,1 --n-vols-along-path 4 --lazy
Status: completed
Duration: 4m 48s
Version: 1.0.0b1
...
HALFMAPS:
  ...
  state003_half1_unfil.mrc
  state003_half2_unfil.mrc

DIAGNOSTICS:
  diagnostics/state003/heterogeneity_distances.txt
  diagnostics/state003/latent_coords.txt
  diagnostics/state003/local_resolution.mrc
  diagnostics/state003/params.pkl
  diagnostics/state003/sampling.mrc
  diagnostics/state003/split_choice.pkl
